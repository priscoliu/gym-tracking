...
- **Command**: Which command to use (prefer: /animate, /extract, /optimize, /overdrive, /arrange, /clarify, /polish, /audit, /typeset, /critique, /harden, /onboard, /adapt, /quieter, /delight, /colorize, /normalize, /distill, /bolder — or other installed skills you're sure exist)
